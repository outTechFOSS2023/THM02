...
mn1,mx1=Vector3(0.0,0.0,(0.14+0.01)),Vector3(0.0565-0.001,0.0565-0.001,2.0) # CORNERS OF THE INITIAL PACKING.
sp1 = pack.SpherePack()
sp1.makeCloud(mn1,mx1,psdSizes=psdSizes,psdCumm=psdCumm,num=8000,distributeMass=1)
