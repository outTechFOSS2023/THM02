...
O.bodies.append(ymport.text('/home/ngoudarzi/Desktop/VST_SA5(Full_Jiang_Penetration_Effect)/Sample Preparation/Samples/layer_SA1_Full_Real_SI_Uncut.txt',material=Regolith,color=Vector3(1.0, 0.1, 0.1)))
...
export.text('/home/ngoudarzi/Desktop/VST_SA5(Full_Jiang_Penetration_Effect)/Sample Preparation/Samples/layer_SA1_Full_Real_SI_Cut.txt')
...
###   DEFINING ENGINES   ###
############################
O.engines=[VTKRecorder(fileName='/home/ngoudarzi/Desktop/VST_SA5(Full_Jiang_Penetration_Effect)/Main Test/VTK/VS_SA1_Full_Jiang_SI/VS_SA1_Full_Jiang_SI' ,recorders=['all'],iterPeriod=250000),
...
def history():
  ...
  plot.saveDataTxt('/home/ngoudarzi/Desktop/VST_SA5(Full_Jiang_Penetration_Effect)/Main Test/Output/VS_SA1_Full_Jiang_SI.txt')
