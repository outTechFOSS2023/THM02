...
VaneCenToVaneBotZ= 0.0565   # THIS IS THE LENGTH OF THE VANE (2.5"). THE LENGTH OF THE ROD ABOVE THE VANE IS ALSO 2.5". 
VaneBotToContBotZ= 12.7e-3  # THIS IS THE DISTANCE FROM THE BOTTOM OF THE CONTAINER TO THE BOTTOM OF THE PENETRATED VANE. 
XcenterofVane= 0.0565/2     # X COORDINATE OF THE VANE CENTER 
YcenterofVane= 0.0565/2     # Y COORDINATE OF THE VANE CENTER
...
O.bodies.append(ymport.text('/home/ngoudarzi/Desktop/VST_SA7(YADE_Periodic_Jiang)/Sample Preparation/Samples/layer_SA5_Regular_Small_Periodic_Real_SI_Uncut.txt',material=Regolith,color=Vector3(1.0, 0.1, 0.1)))
...
export.text('/home/ngoudarzi/Desktop/VST_SA7(YADE_Periodic_Jiang)/Sample Preparation/Samples/layer_SA5_Regular_Small_Periodic_Real_SI_Cut.txt')
...
EO = ymport.stl('/home/ngoudarzi/Desktop/VST_SA7(YADE_Periodic_Jiang)/Cad/Zero_Thickness_Central_Periodic_Vane.stl',shift=Vector3(0,0,0),wire=True,color=Vector3(0.5,0.6,0.8))
for i in EO:
  i.state.mass = 1
...
boxLengthX=0.0565/2-0.003
boxLengthY=0.0565/2-0.003
boxLengthZ=0.07
## BOTTOM BOUNDARY
...
###   DEFINING ENGINES   ###
############################
O.engines=[VTKRecorder(fileName='/home/ngoudarzi/Desktop/VST_SA7(YADE_Periodic_Jiang)/Main Test/VTK/VS_SA5_Regular_Small_Periodic_Real_SI/VS_SA5_Regular_Small_Periodic_Real_SI' ,recorders=['all'],iterPeriod=250000),
...
def vaneShear():
  ...
  vaneRotZ=-((shearVane.state.rot().norm())*(180/math.pi)-120) # GETTING THE ROTATION OF THE VANE (DIFFERENCE BETWEEN refOri AND ori AND CONVERSION TO DEGREES)
...
def history():
  ...
  vaneRotZ=-((shearVane.state.rot().norm())*(180/math.pi)-120)
  ...
  plot.saveDataTxt('/home/ngoudarzi/Desktop/VST_SA7(YADE_Periodic_Jiang)/Main Test/Output/VS_SA5_Regular_Small_Periodic_Real_SI.txt')
