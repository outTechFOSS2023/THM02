...
O.bodies.append(ymport.text('/home/ngoudarzi/Desktop/VST_SA7(YADE_Periodic_Jiang)/Sample Preparation/Samples/layer_SA5_Central_Periodic_Real_SI_Uncut.txt',material=Regolith,color=Vector3(1.0, 0.1, 0.1)))
...
export.text('/home/ngoudarzi/Desktop/VST_SA7(YADE_Periodic_Jiang)/Sample Preparation/Samples/layer_SA5_Central_Periodic_Real_SI_Cut.txt')
...
###   DEFINING ENGINES   ###
############################
O.engines=[VTKRecorder(fileName='/home/ngoudarzi/Desktop/VST_SA7(YADE_Periodic_Jiang)/Main Test/VTK/VS_SA5_Central_Periodic_Real_SI/VS_SA5_Central_Periodic_Real_SI' ,recorders=['all'],iterPeriod=250000),
...
def history():
  ...
  plot.saveDataTxt('/home/ngoudarzi/Desktop/VST_SA7(YADE_Periodic_Jiang)/Main Test/Output/VS_SA5_Central_Periodic_Real_SI.txt')
